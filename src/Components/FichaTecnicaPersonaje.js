...
export default function FichaTecnicaPersonaje({ elemento }) {
    ...
    return (
        <React.Fragment>
            <div style={{ alignItems: "center", justifyContent: "center", marginTop: "25px" }}>
                ...
                {items.map(dato => {
                    ...
                    return (
                        <div style={{ maxWidth: "1000px" }}>
                            <label style={{ color: "goldenrod", wordWrap: "break-word", fontWeight:"light", marginLeft: "10px" }}>{dato[0].toUpperCase()}: {dato[1]} </label>
                        </div>
                    )
                })}
