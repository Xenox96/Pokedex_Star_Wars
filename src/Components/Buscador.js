...
export default function Buscador() {
    ...
    return (
        <div>
            ...
            {busqueda && <div class="elemento baseLetrasIntro">
                <div class="letrasIntro">
                    <div style={{ minHeight: "20px", color: "goldenrod", textAlign: "center" }}>
                        <div style={{ minHeight: "20px", color: "goldenrod", textAlign: "center", display: "inline-block" }}>
                            {busqueda && <RecuperadorElementos tipo={tipo} language={language} value={indice} guardarElemento={guardarElemento}></RecuperadorElementos>}
                        </div>
                    </div>
                </div>
                <button style={{ position: "relative", left: "500%", color:"skyblue", backgroundColor: "transparent" }} type="button" title="Close snackbar" className="dark:border-transparent" onClick={() => setBusqueda(false)}>
                    X
                </button>
            </div>}
        </div>
